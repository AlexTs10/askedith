...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-0 z-[100] flex max-h-screen w-full flex-col items-center justify-center p-4",
      className
    )}
    {...props}
  />
