...
import {
  ...
  getCategoryLabel,
  getCategoryIcon,
} from "@/components/search/DefaultCategoryImages";
...
export default function CleanResults() {
  ...
  const toggleResource = (id: number) => {
    ...
    if (isSelected) {
      newSelectedIds = state.selectedResourceIds.filter(
  ...
  const handleContinue = () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Something went wrong preparing your emails. Please try again.",
        variant: "destructive",
      });
    }
  };
        ...
        <div className="max-w-6xl mx-auto py-8">
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <p className="text-red-600 font-medium mb-2">
              We encountered a problem while finding resources for you.
            </p>
      ...
      <div className="pt-16 bg-gray-100 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="font-serif text-2xl text-teal-600 mb-1">
                Search Results
              </h1>
              <p className="text-gray-600">
                Showing results for "senior support"
              </p>
            </div>
            <div className="flex gap-2">
              <Button
                variant="outline"
                className="border-gray-300 flex items-center gap-2 text-gray-700 hover:bg-gray-50"
              >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {state.selectedResourceIds.length > 0 && (
          <div className="mt-12 text-center">
            ...
            >
              Continue with {state.selectedResourceIds.length} Selected Resource
              {state.selectedResourceIds.length !== 1 ? "s" : ""}
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <p className="text-gray-600 text-sm mt-3">
              You'll have a chance to review and edit your message before
              sending
            </p>
          </div>
        )}
      ...
      <footer className="bg-gray-100 border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Logo section */}
            <div>
              <div className="font-serif text-xl text-teal-600 mb-4">
                AskEdith
              </div>
              <p className="text-gray-600 text-sm">
                Connecting seniors and their families with the support they
                need.
              </p>
            </div>
